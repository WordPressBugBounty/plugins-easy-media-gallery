...
<!-- Modal -->
<div class="modal fade" id="myModalupgrade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
                ...
                <div class="row flat">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-6">
                        <ul class="plan plan1">
                            ...
                            <li class="plan-action">
                                <a href="https://ghozylab.com/plugins/ordernow.php?order=pro&utm_source=lite&utm_medium=editor&utm_campaign=orderfromeditor"
                                    target="_blank" class="btn btn-danger btn-lg">BUY NOW</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-6"><span class="featured"></span>
                        <ul class="plan plan1">
                            ...
                            <li class="plan-action">
                                <a href="https://ghozylab.com/plugins/ordernow.php?order=proplus&utm_source=lite&utm_medium=editor&utm_campaign=orderfromeditor"
                                    target="_blank" class="btn btn-danger btn-lg">BUY NOW</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-6">
                        <ul class="plan plan1">
                            ...
                            <li class="plan-action">
                                <a href="https://ghozylab.com/plugins/ordernow.php?order=proplusplus&utm_source=lite&utm_medium=editor&utm_campaign=orderfromeditor"
                                    target="_blank" class="btn btn-danger btn-lg">BUY NOW</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-6">
                        <ul class="plan plan1">
                            ...
                            <li class="plan-action">
                                <a href="https://ghozylab.com/plugins/ordernow.php?order=dev&utm_source=lite&utm_medium=editor&utm_campaign=orderfromeditor"
                                    target="_blank" class="btn btn-danger btn-lg">BUY NOW</a>
                            </li>
                        </ul>
                    </div>
...
jQuery(document).ready(function($) {
    ...
    jQuery("#easmedia_metabox_media_video").change(function() {
        ...
        if (vdo_url.match('https://new\.livestream\.com')) {
    ...
    jQuery('#videofrmt').on('click', function() {
        new Messi(
            '<p> - <strong>Youtube 1 :</strong> https://www.youtube.com/watch?v=JaNH56Vpg-A</p><p> - <strong>Youtube 2 :</strong> https://www.youtube.com/embed/JaNH56Vpg-A</p><p> - <strong>Youtube 3 :</strong> https://youtu.be/BWmWAPb_z90</p><p> - <strong>Youtube Playlist :</strong> https://www.youtube.com/watch?v=S_Az2Zg5OLc&list=PLFrmfElpm4lwVff3JvmtSJzxYFFb2093q</p><p> - <strong>Vimeo :</strong> https://vimeo.com/798022</p><p> - <strong>DailyMotion :</strong> https://www.dailymotion.com/video/xzefrs_steven-spielberg-s-obama_shortfilms#.UX8g_O8kZM4</p><p> - <strong>MetaCafe :</strong> https://www.metacafe.com/watch/2185365/spot_electrabel_gdf_suez_happy_new_year_2009/</p><p> - <strong>Facebook 1 :</strong> https://www.facebook.com/video/embed?video_id=557900707562656</p><p> - <strong>Facebook 2 :</strong> https://www.facebook.com/gopro/videos/10153893757506919/</p><p> - <strong>Veoh :</strong> https://www.veoh.com/watch/v20943320Dz9Z45Qj</p><p> - <strong>Flickr video :</strong> https://www.flickr.com/photos/bhl1/2402027765/in/pool-video</p><p> - <strong>Google video :</strong> https://video.google.com/videoplay?docid=-8111235669135653751</p><p> - <strong>Quietube + Youtube :</strong> https://quietube.com/v.php/https://www.youtube.com/watch?v=b5Ff2X_3P_4</p><p> - <strong>Quietube + Vimeo :</strong> https://quietube.com/v.php/https://vimeo.com/2295261</p><p> - <strong>Tudou :</strong> https://www.tudou.com/programs/view/KG2UG_U4DMY/</p><p> - <strong>YouKu :</strong> https://v.youku.com/v_show/id_XNDI1MDkyMDQ==.html</p>', {
                title: 'Sample video format',
                modal: true
            });
    });

    jQuery('.messivideo').bind('click', function() {
        new Messi('<iframe width="853" height="480" src="' + jQuery(this).data("yvid") +
        ...
        jQuery.ajax({
            ...
            fail: function(xhr, d, e) {
                if (xhr.status != 200) {
                    ...
                    jQuery('#notifynovalidaudio').html(
                        "Unable to load audio from url above. Please make sure it's the <strong>full</strong> URL and a valid one at that."
                        );
                    jQuery(".deleteaudio").hide("fast");
                    jQuery("#audioprev").hide("fast");
                }
...
function IsValidImageUrl(url) {
    jQuery("<img>", {
        ...
        fail: function() {
            ...
            jQuery('#notifynovalidimg').html(
                "Unable to load image from url above. Please make sure to input <strong>full</strong> URL."
                );
            jQuery("#imgpreviewbox").hide("slow");
            jQuery(".deleteimage").hide("slow");
        ...
        load: function() {
            ...
            jQuery.post(ajaxurl, data, function(response) {
                ...
                jQuery("#imgpreviewbox").css("width", sprdata[1] + "px");
                jQuery("#imgpreviewbox").css("height", sprdata[2] + "px");
	...
	foreach ( $meta_box['fields'] as $field ) {
		...
		switch ( $field['type'] ) {
			...
			case 'video':
				...
				<img id="videothumbnailprv" style="display:none;" src="https://app.ghozylab.com/placehold/300x190" height="190" width="300"/></div>
				</td>';
				break;
			...
			case 'images':
				...
				$img_meta = get_post_meta($post->ID, 'easmedia_metabox_img', true);

				if ($img_meta) {
					$attid = wp_get_attachment_image_src( emg_get_attachment_id_from_src($img_meta), 'full' );
...
function easmedia_save_meta_box( $post_id ) {
	...
	foreach ( $_POST['easmedia_meta'] as $key => $val ) {
		if ( ! is_array( $val ) ) {
				$_POST['easmedia_meta'][ $key ] = esc_html( $val );
		} else {
			$_POST['easmedia_meta'][ $key ] = array();
			foreach ( $val as $arr_val ) {
				$_POST['easmedia_meta'][ $key ][] = stripslashes( $arr_val );
			}
		}
	}
		// save data

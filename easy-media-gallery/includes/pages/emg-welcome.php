...
class EMG_Welcome {
	...
	public function emg_admin_head() {
		...
		.post-type-easymediagallery .about-wrap {
		...
		.emg-theme-list li.free-themes-item {
			position:relative;
		...
		.emg-theme-list .theme-details-cont {
			position:relative;
			padding: 15px;
			border-top: 1px solid #e5e5e5;
		}
		
		.emg-theme-list .theme-sc {
			position:relative;
			display: block;
			max-width: 100%;
		...
		/* Theme list */
		.easymediagallery_page_emg-free-themes .feature-section {
			margin-top:0;
			padding-top:20px;	
		}
		.theme-list-container {
